...
// Generiamo l'array con i percorsi delle immagini s1.jpg fino a s9.jpg
const images = Array.from({ length: 9 }, (_, i) => `/stillLife/s${i + 1}.jpg`);
